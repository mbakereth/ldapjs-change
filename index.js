...
class Change {
   ...
   * @property {object | import('@mbakereth/ldapjs-attribute')} modification An attribute
   ...
   *
   * @param {object|import('@mbakereth/ldapjs-attribute')} mod
   *
   ...
   *
   * @param {import('@mbakereth/ldapjs-asn1').BerReader} ber The BER to process. It must
